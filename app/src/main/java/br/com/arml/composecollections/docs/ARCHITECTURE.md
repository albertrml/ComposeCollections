...
- **Overlay Orchestration**: The Scaffold manages a `topOverlay` slot used by Grid components to implement virtual sticky headers, bypassing framework limitations.
