    ...
    Column(
        ...
        if (showScrollToTop) {
            FastScrollButton(
                ...
                text = stringResource(R.string.quickNavList_upButton_text),
        ...
        if (showScrollToBottom) {
            FastScrollButton(
                ...
                text = stringResource(R.string.quickNavList_downButton_text),
                icon = Icons.Filled.KeyboardArrowDown,
                iconContentDescription = stringResource(
                    R.string.quickNavList_downButton_contentDescription
                ),
                onClick = {
                    scope.launch {
